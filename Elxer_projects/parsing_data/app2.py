            ...
            if len(event) != 0:
                ...
                match event[0]:
                    ...
                    case "offline" | "Dying Gasp" | "DYING_GASP" | "online" | "ONU Deregister" | "ONU Register" | "deregistered" | "registered" | "ONU AUTH Success" | "ONU MAC Conflict" | "configuration error":
                        ...
                        time1 = datetime.strptime(time2, "%Y-%m-%d %H:%M:%S")
                        time2 = datetime.strptime(curr_date_time, "%Y-%m-%d %H:%M:%S")
                        ...
                        if len(check_reason)!=0:
                            ...
                            match reason:
                                ...
                                case "POWER OFF":
                                    ...
                                    data4=({"date_time":time2,"host_ip":hostip,"event":message,"pon_id":pon_id,"onu_number":onu_id})
                                    ...
                                    if onu_offline_database != None:
                                        ...
                                        if only_time!=curr_time and time_error_db is None:
                                                error_time_data(data1)
                                        all_log.insert_one(data1)
                            ...
                            match event[0]:
                                ...
                                case "ONU Register":
                                    ...
                                    data=({"date_time":time2,"curr_date_time":curr_date_time,"Time Difference":time_difference,"host_ip":hostip,"event":event[0],"pon_id":pon_id,"onu_number":onu_id})
                                    data1=data.copy()
                                ...
                                case "online" | "ONU AUTH Success" | "registered":
                                    ...
                                    data1=({"date_time":time2,"curr_date_time":curr_date_time,"Time Difference":time_difference,"host_ip":hostip,"event":event[0],"pon_id":pon_id,"onu_number":onu_id})
                                    event="ONU ONLINE"
                                    data2=({"date_time":time2,"host_ip":hostip,"event":event,"pon_id":pon_id,"onu_number":onu_id})
                                    onu_off_database=onu_offline_collection.find_one(data)
                                    poweroff_database=poweroff_collection.find_one(data)
                                    time_error_db=time_error_collection.find_one(data)   
                                    data3=data2.copy()
                                ...
                                case "ONU MAC Conflict" | "configuration error":
                                    ...
                                    issue=message
                                    event="ONU Error"
                                    data={"date_time":time2,"host_ip":hostip,"event":event,"issue":issue,"pon_id":pon_id,"onu_number":onu_id}
                    ...
                    case 'PON LOS' | 'PON LOS Recovery':
                        ...
                        match event[0]:
                            case 'PON LOS':
                                ...
                                data= {"date_time":time2,"host_ip":hostip,"event":event[0],"pon_id":pon_id}
                            ...
                            case 'PON LOS Recovery': 
                                ...
                                data= {"date_time":time2,"host_ip":hostip,"event":event,"pon_id":pon_id}  
                                data2=data.copy()
                                # print(data1)
                                # print(data) 
                    ...
                    case "LinkDown"|"LinkUp":
                        ...
                        match event[0]:
                            ...
                            case "LinkDown":
                                ...
                                event="PON LOS"
                                data= {"date_time":time_linkupdown,"host_ip":hostip,"event":event,"pon_id":pon_id} 
                                data2=data.copy()
                                # print(data1)
                                # print(data)  
